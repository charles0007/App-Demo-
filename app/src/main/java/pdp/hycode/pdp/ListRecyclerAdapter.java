...
//                mainLayout = (RelativeLayout) vi.findViewById(R.id.mainLayout);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.users_list_cardview, parent, false);
...
//
//}
        view.setOnClickListener(UsersList.myOnClickListener);
        view.setOnCreateContextMenuListener((View.OnCreateContextMenuListener) UsersList.myOnClickListener);
