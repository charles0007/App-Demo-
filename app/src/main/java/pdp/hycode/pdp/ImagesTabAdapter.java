...
public class ImagesTabAdapter extends RecyclerView.Adapter<ImagesTabAdapter.MyViewHolder> {
...
//            view_user= (TextView) vi.findViewById(R.id.view_user);
    ...
    public ImagesTabAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
...
//}
//        view.setOnClickListener(ImagesTabfragment.myOnClickListener);
//        view.setOnCreateContextMenuListener((View.OnCreateContextMenuListener) ImagesTabfragment.myOnClickListener);
...
//        email.setTypeface(typeface);
        ...
        listDriver = data.get(listPosition);
          strDescription = listDriver.get("Description");
        final String chatId = listDriver.get("chatId");
        final String image = listDriver.get("Image");
        final String title = listDriver.get("Title");
...
//        usernameUc=usernameUc+" "+username.split(" ")[1].substring(0, 1).toUpperCase() + username.split(" ")[1].substring(1).toLowerCase();
        ...
        description.setText(strDescription.substring(0,100));
...
//                    new ImageClicked(activity, v, title, image, null, "");
//                }
                Intent intent = new Intent(activity, Description.class);
                intent.putExtra("DescriptionId", chatId);
                intent.putExtra("DescriptionToken", txtToken.getText().toString());
                intent.putExtra("image_txt", image);
                intent.putExtra("Title", titleUc);
