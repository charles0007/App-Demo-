...
import pdp.hycode.pdp.firebase_notification.Data;
...
//                    .into(userLogo);
            GlideApp.with(FragmentChat.this)
                    .load(Integer.parseInt(chatWithImage))
                    .placeholder(ImgShowDefault(sex))
                    .error(ImgShowDefault(sex))
                    .circleCrop()
                    .into(userLogo);
...
//                         String Page="",Image="",Sex="",userId="",Email="";
//                        try {
//                            Page = sessionManagement.get("Page");
//                            Image= sessionManagement.get("Image");
//                            Sex= sessionManagement.get("Sex");
//                            Email= sessionManagement.get("Email");
//                           userId= sessionManagement.getUserDetails().get("User");
//                        } catch (Exception ex) {
//                            Page = "";
//                        }
//                        sendNotifyTask(sessionManagement.get("MyUsername"), messageText, token, Image, userId, intent.getStringExtra("distKm"), Sex, Email, Page);
...
//                                }
//                                if (notSetAdapter != null) {
//                                    msgCount = notSetAdapter.getItemCount() + msgCount;
//                                }
//
...
//        }
    ...
    public void sendNotifyTask(String title, String message, String mtoken, String Image,
                               String userId, String distKm, String sex, String email, String page) {
