...
public class VideosTabAdapter extends RecyclerView.Adapter<VideosTabAdapter.MyViewHolder> {
...
//            view_user= (TextView) vi.findViewById(R.id.view_user);
    ...
    public VideosTabAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
...
//
//}
        view.setOnClickListener(VideosTabfragment.myOnClickListener);
        view.setOnCreateContextMenuListener((View.OnCreateContextMenuListener) VideosTabfragment.myOnClickListener);
